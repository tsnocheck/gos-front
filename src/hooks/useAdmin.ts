...
export const useAdmin = () => {
  ...
  return {
    activateUser: (userId: string) =>
      changeUserStatusMutation.mutateAsync({ userId, status: UserStatus.ACTIVE }),
    deactivateUser: (userId: string) =>
      changeUserStatusMutation.mutateAsync({ userId, status: UserStatus.INACTIVE }),
    createUser: createUserMutation.mutateAsync,
    deleteUser: deleteUserMutation.mutateAsync,
    archiveUser: archiveUserMutation.mutateAsync,
    unarchiveUser: unarchiveUserMutation.mutateAsync,
    updateUser: (userId: string, data: Omit<AdminUpdateUserData, 'userId'>) =>
