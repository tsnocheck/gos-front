...
const ProtectedRoute = lazy(() =>
  import('./components/ProtectedRoute.tsx').then((module) => ({ default: module.ProtectedRoute })),
);
const AdminArchivePage = lazy(() =>
  import('./pages/AdminArchivePage.tsx').then((module) => ({ default: module.AdminArchivePage })),
);
const ResetPasswordPage = lazy(() =>
  import('./pages/ResetPasswordPage.tsx').then((module) => ({ default: module.ResetPasswordPage })),
);
const AdminDictionariesPage = lazy(() =>
  import('./pages/AdminDictionariesPage').then((module) => ({
    default: module.AdminDictionariesPage,
  })),
);
const AdminExpertReplacePage = lazy(() =>
  import('./pages/AdminExpertReplacePage').then((module) => ({
    default: module.AdminExpertReplacePage,
  })),
);
const AdminProgramsPage = lazy(() =>
  import('./pages/AdminProgramsPage.tsx').then((module) => ({ default: module.AdminProgramsPage })),
);
const AdminCandidatesPage = lazy(() =>
  import('./pages/AdminCandidatesPage.tsx').then((module) => ({
    default: module.AdminCandidatesPage,
  })),
);
...
const generateRoutes = (routes: TRoute[]): React.ReactNode => {
  return routes.map((route) => {
    ...
    if (route.protected) {
      element = (
        <ProtectedRoute requiredRoles={route.requiredRoles ?? undefined}>{element}</ProtectedRoute>
      );
    }
